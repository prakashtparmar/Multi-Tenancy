                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <template x-if="activeOrder?.billing_address">
                                    <div
                                        ...
                                        <div
                                            class="px-5 py-4 border-b border-border/40 bg-muted/20 flex items-center gap-2">
                                            <div
                                                class="p-1.5 bg-background rounded-md shadow-sm text-primary group-hover:text-primary/80 transition-colors">
                                        ...
                                        <div class="p-5 flex-1 grid grid-cols-2 gap-y-4 gap-x-2 text-sm">
                                            ...
                                            <div class="col-span-2">
                                                <span
                                                    class="text-[10px] uppercase tracking-wider text-muted-foreground/80 font-semibold block mb-0.5">Country</span>
                                                <span class="font-medium text-foreground"
                                                    x-text="activeOrder.billing_address.country || '-'"></span>
                                            </div>
                                        </div>
                                        <div
                                            class="px-5 py-3 bg-muted/10 border-t border-border/40 flex justify-between items-center mt-auto">
                                            <div>
                                                <span
                                                    class="text-[10px] uppercase tracking-wider text-muted-foreground/80 font-semibold block">Pincode</span>
                                                <span class="font-bold text-primary font-mono"
                                                    x-text="activeOrder.billing_address.pincode || '-'"></span>
                                            </div>
                                            <div class="text-right" x-show="activeOrder.billing_address.contact_phone">
                                                <span
                                                    class="text-[10px] uppercase tracking-wider text-muted-foreground/80 font-semibold block">Phone</span>
                                        ...
                                        <div class="p-5 flex-1 grid grid-cols-2 gap-y-4 gap-x-2 text-sm">
                                            ...
                                            <div class="col-span-2">
                                                <span
                                                    class="text-[10px] uppercase tracking-wider text-muted-foreground/80 font-semibold block mb-0.5">Country</span>
                                                <span class="font-medium text-foreground"
                                                    x-text="activeOrder.shipping_address.country || '-'"></span>
                                            </div>
                                        </div>
                                        <div
                                            class="px-5 py-3 bg-muted/10 border-t border-border/40 flex justify-between items-center mt-auto">
                                            ...
                                            <div class="text-right" x-show="activeOrder.shipping_address.contact_phone">
                                                <span
                                                    class="text-[10px] uppercase tracking-wider text-muted-foreground/80 font-semibold block">Phone</span>
                                                <span class="font-medium font-mono"
