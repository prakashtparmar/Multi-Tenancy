                ...
                <table class="w-full caption-bottom text-sm">
                    ...
                    <tbody class="[&_tr:last-child]:border-0 text-sm">
                        ...
                        <tr class="group border-b border-border/40 transition-all duration-200 hover:bg-muted/40 data-[state=selected]:bg-muted/60">
                            ...
                            <td class="p-6 align-middle">
                                <span class="capitalize text-xs font-medium text-muted-foreground">{{ $order->payment_status }}</span>
                            </td>
                            <td class="p-6 align-middle">
                                <span class="capitalize text-xs font-medium text-muted-foreground">{{ $order->shipping_status }}</span>
                            </td>
