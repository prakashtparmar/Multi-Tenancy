...
>
    <!-- Logo Area -->
    <div class="h-20 flex items-center px-6 border-b border-sidebar-border/50 relative overflow-hidden shrink-0 group/logo">
        <div class="absolute inset-0 bg-gradient-to-r from-primary/5 via-primary/0 to-transparent opacity-0 group-hover/logo:opacity-100 transition-opacity duration-700"></div>
        
        <a href="{{ url('/dashboard') }}" class="flex items-center gap-3.5 relative z-10 w-full" :class="sidebarCollapsed ? 'justify-center' : ''">
            <div class="h-10 w-10 rounded-xl bg-gradient-to-br from-primary to-violet-600 flex items-center justify-center shadow-lg shadow-primary/20 shrink-0 transition-all duration-500 group-hover/logo:scale-105 group-hover/logo:rotate-3 ring-1 ring-white/20">
                <!-- Premium Logo Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-white"><path d="M15 6v12a3 3 0 1 0 3-3H6a3 3 0 1 0 3 3V6a3 3 0 1 0-3 3h12a3 3 0 1 0-3-3"/></svg>
            </div>
            <div class="flex flex-col overflow-hidden transition-all duration-500 ease-out" 
                ...
                <span class="font-heading font-bold text-lg tracking-tight leading-none text-foreground group-hover/logo:text-primary transition-colors duration-300">
                    {{ tenant('id') ? ucfirst(tenant('id')) : 'Central Admin' }}
                </span>
                <span class="text-[10px] font-bold text-muted-foreground uppercase tracking-[0.2em] mt-1 pl-0.5">Workspace</span>
            </div>
        </a>
    </div>
    ...
    <div class="flex-1 overflow-y-auto custom-scrollbar py-6 px-4 space-y-8">
        ...
        <!-- SECTION: OVERVIEW -->
        <div class="space-y-1">
             <div class="px-3 mb-3 transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 h-0 hidden' : 'opacity-100'">
                <h3 class="text-[10px] font-extrabold uppercase tracking-widest text-muted-foreground/50">
                    Overview
                </h3>
            </div>
        ...
        <div class="space-y-1">
            ...
            <!-- 1. CATALOG (Define Products) -->
            <x-layout.nav-collapsible title="Catalog" :active="request()->is('products*') || request()->is('central/products*') || request()->is('categories*') || request()->is('collections*') || request()->is('inventory*')" :items="[
                [
                    'title' => 'Products', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'m7.5 4.27 9 5.15\'/><path d=\'M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z\'/><path d=\'m3.3 7 8.7 5 8.7-5\'/><path d=\'M12 22V12\'/></svg>'
                ],
                [
                    'title' => 'Categories', 
                    'url' => tenant() ? route('tenant.categories.index') : route('central.categories.index'),
                    'active' => request()->is('categories*'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M3 6h18\'/><path d=\'M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2\'/><path d=\'M12 11h.01\'/><path d=\'M12 16h.01\'/><path d=\'M8 11h.01\'/><path d=\'M8 16h.01\'/><path d=\'M16 11h.01\'/><path d=\'M16 16h.01\'/><rect width=\'18\' height=\'14\' x=\'3\' y=\'6\' rx=\'2\'/></svg>'
                ],
                [
                    'title' => 'Collections', 
                    'url' => tenant() ? route('tenant.collections.index') : route('central.collections.index'),
                    'active' => request()->is('collections*'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'m16 6 4 14\'/><path d=\'M12 6v14\'/><path d=\'M8 8v12\'/><path d=\'M4 4v16\'/></svg>'
                ]
            ]">
                <x-slot name="icon">
             ...
             <!-- 2. PROCUREMENT (Acquire Inventory) -->
             <x-layout.nav-collapsible title="Procurement" :active="request()->is('purchase-orders*') || request()->is('central/purchase-orders*') || request()->is('suppliers*') || request()->is('central/suppliers*') || request()->is('warehouses*') || request()->is('central/warehouses*')" :items="[
                [
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z\'/><path d=\'M3 6h18\'/><path d=\'M16 10a4 4 0 0 1-8 0\'/></svg>'
                ],
                [
                    'title' => 'Suppliers', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M14 9a2 2 0 0 1-2 2H6l-4 4V4c0-1.1.9-2 2-2h8a2 2 0 0 1 2 2z\'/><path d=\'M18 9h2a2 2 0 0 1 2 2v11l-4-4h-6a2 2 0 0 1-2-2v-1\'/></svg>'
                ],
                [
                    'title' => 'Warehouses', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 0 1-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0 1 16 0\'/><circle cx=\'12\' cy=\'10\' r=\'3\'/></svg>'
                ],
            ]">
                <x-slot name="icon">
            ...
            <!-- 3. SALES & FULFILLMENT (Sell & Deliver) -->
            <x-layout.nav-collapsible title="Sales & Orders" :active="request()->is('orders*') || request()->is('central/orders*') || request()->is('invoices*') || request()->is('central/invoices*') || request()->is('shipments*') || request()->is('central/shipments*') || request()->is('returns*') || request()->is('central/returns*')" :items="[
                [
                    'title' => 'All Orders', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><rect width=\'16\' height=\'20\' x=\'4\' y=\'2\' rx=\'2\' ry=\'2\'/><path d=\'M9 22v-4h6v4\'/><path d=\'M8 6h.01\'/><path d=\'M16 6h.01\'/><path d=\'M12 6h.01\'/><path d=\'M12 10h.01\'/><path d=\'M12 14h.01\'/><path d=\'M16 10h.01\'/><path d=\'M16 14h.01\'/><path d=\'M8 10h.01\'/><path d=\'M8 14h.01\'/></svg>'
                ],
                [
                    'title' => 'Invoices', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z\'/><polyline points=\'14 2 14 8 20 8\'/><path d=\'M16 13H8\'/><path d=\'M16 17H8\'/><path d=\'M10 9H8\'/></svg>'
                ],
                [
                    'title' => 'Shipments', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M10 17h4V5H2v12h3\'/><path d=\'M20 17h2v-3.34a4 4 0 0 0-1.17-2.83L19 9h-5\'/><path d=\'M14 17h1\'/><circle cx=\'7.5\' cy=\'17.5\' r=\'2.5\'/><circle cx=\'17.5\' cy=\'17.5\' r=\'2.5\'/></svg>'
                ],
                [
                    'title' => 'Returns (RMA)', 
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M9 14 2 9l7-5\'/><path d=\'M20 20v-7a4 4 0 0 0-4-4H2\'/></svg>'
                ],
            ]">
                 <x-slot name="icon">
            ...
            <!-- 4. CRM (Manage Relationships) -->
             <x-layout.nav-collapsible title="Customers" :active="request()->is('customers*')" :items="[
                [
                    'title' => 'All Customers', 
                    'url' => '/customers', 'active' => request()->is('customers'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2\'/><circle cx=\'9\' cy=\'7\' r=\'4\'/><path d=\'M22 21v-2a4 4 0 0 0-3-3.87\'/><path d=\'M16 3.13a4 4 0 0 1 0 7.75\'/></svg>'
                ],
                [
                    'title' => 'Add Customer', 
                    'url' => '/customers/create', 'active' => request()->is('customers/create'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2\'/><circle cx=\'9\' cy=\'7\' r=\'4\'/><line x1=\'19\' x2=\'19\' y1=\'8\' y2=\'14\'/><line x1=\'22\' x2=\'16\' y1=\'11\' y2=\'11\'/></svg>'
                ],
                [
                    'title' => 'Segments', 
                    'url' => '#',
                    'active' => false,
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M10 21.9a10 10 0 0 0 9.9-9.9\'/><path d=\'M2 12a10 10 0 0 1 7-9.4\'/><path d=\'M22 12A10 10 0 0 0 12 2v10Z\'/></svg>'
                ],
            ]">
                <x-slot name="icon">
        ...
        <div class="space-y-1">
             ...
             <x-layout.nav-collapsible title="Online Store" :active="request()->is('storefront*')" :items="[
                [
                    'title' => 'Themes', 'url' => '#', 'active' => false,
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M2 13.381h20M8.66 13.381V7.924a2.72 2.72 0 0 1 5.44 0v5.457M3.36 17.924a2.72 2.72 0 0 1 5.44 0v-4.543H3.36v4.543zM15.2 13.381h5.44v4.543a2.72 2.72 0 0 1-5.44 0v-4.543z\'/></svg>'
                ],
                [
                    'title' => 'Blog Posts', 'url' => '#', 'active' => false,
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2z\'/><path d=\'M22 3h-6a4 4 0 0 0-4 4v14a3 3 0 0 1 3-3h7z\'/></svg>'
                ],
                [
                    'title' => 'Navigation', 'url' => '#', 'active' => false,
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5\'/><path d=\'M21 5c0 1.66-4 3-9 3S3 6.66 3 5s4-3 9-3 9 1.34 9 3z\'/><path d=\'M3 12c0 1.66 4 3 9 3s9-1.34 9-3\'/></svg>'
                ],
            ]">
                <x-slot name="icon">
        ...
        <div class="space-y-1">
             ...
             <x-layout.nav-collapsible title="Team" :active="request()->is('users*') || request()->is('roles*') || request()->is('permissions*')" :items="[
                [
                    'title' => 'Users', 
                ...
                [
                    ...
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><rect width=\'18\' height=\'18\' x=\'3\' y=\'3\' rx=\'2\'/><path d=\'M9 3v18\'/></svg>'
                ],
                [
                    'title' => 'Permissions', 
                    'url' => '/permissions', 'active' => request()->is('permissions*'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10\'/></svg>'
                ],
            ]">
                <x-slot name="icon">
            ...
            <x-layout.nav-collapsible title="System Settings" :active="request()->is('settings*') || request()->is('activity-logs*')" :items="[
                [
                    'title' => 'General Settings', 
                    'url' => '/settings', 'active' => request()->is('settings'),
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.72V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.17a2 2 0 0 1 1-1.74l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z\'/><circle cx=\'12\' cy=\'12\' r=\'3\'/></svg>'
                ],
                [
                    'title' => 'Audit Logs', 
                ...
                [
                    ...
                    'url' => '#', 
                    'active' => false,
                    'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.5\' stroke-linecap=\'round\' stroke-linejoin=\'round\' class=\'size-4 text-muted-foreground/70\'><path d=\'M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9\'/><path d=\'M10.3 21a1.94 1.94 0 0 0 3.4 0\'/></svg>'
                ],
            ]">
                <x-slot name="icon">
