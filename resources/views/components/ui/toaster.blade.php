...
<div 
    ...
    "
    class="fixed {{ $classes }} z-[100] flex flex-col gap-2 w-full max-w-sm pointer-events-none"
>
    <template x-for="note in notifications" :key="note.id">
        ...
        >
            <div class="flex items-start gap-4">
                ...
                <button @click="dismiss(note.id)" class="shrink-0 rounded-lg p-1 text-muted-foreground/50 hover:bg-muted hover:text-foreground transition-colors">
